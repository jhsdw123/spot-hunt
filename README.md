# Spot Hunt — Spot the Difference Game
...
- Countdown timer with find bonus / miss penalty, hints, star ratings
- Installable PWA with offline caching (app shell + played puzzles)
- Phase 2 (planned): realtime versus mode via Supabase Realtime
